...
import com.liu.dto.ScrollResult;
...
import static com.liu.utils.RedisConstants.BLOG_LIKED_KEY;
import static com.liu.utils.RedisConstants.FEED_KEY;
...
public class BlogServiceImpl extends ServiceImpl<BlogMapper, Blog> implements IBlogService {
    ...
    public Result saveBlog(Blog blog) {
        ...
        if(!isSuccess){
            return Result.fail("ブロックの保存を失敗しました");
        }
